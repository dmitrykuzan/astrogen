...
export const modals = () => {
  ...
  function bindModal(
    ...
    if (triggers && modal) {
      ...
      // Обработчик клика по крестику и другим кнопкам
      if (closeSelector) {
  ...
  bindModal(".modal-we-work-trigger", ".modal--we-work", ".modal__close");
  bindModal(".modal--thanks-trigger", ".modal--thanks", ".modal__close");
